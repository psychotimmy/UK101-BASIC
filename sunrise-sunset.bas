...
160 Z1=DR*90.833: REM Zenith dist.
...
470 RETURN
480 REM
490 REM  Test an hour for an event
500 L0=T0+C0*K1: L2=L0+K1
510 H0=L0-A0: H2=L2-A2
520 H1=(H2+H0)/2: REM  Hour angle,
530 D1=(D2+D0)/2: REM  declination,
540 REM                at half hour
...
690 T3=C0+E+1/120: REM Round off
...
790 PRINT ", azimuth";AZ
800 RETURN
810 REM
820 REM   Special-message routine
...
890 RETURN
900 REM
910 REM   Fundamental arguments
920 REM     (Van Flandern &
930 REM     Pulkkinen, 1979)
...
1100 REM
1110 REM    Compute Sun's RA and Dec
1120 S=W/SQR(U-V*V)
...
1345 REM It correctly describes what happens in the 
1350 REM arctic and antarctic regions, 
...
1370 REM For the time zone, enter the number of 
1375 REM west of Greenwich.
1380 REM (e.g. 0 for GMT, -1 for BST).
1385 REM The calculation is discussed
1390 REM in Sky & Telescope August 1994, page 84.                                    
