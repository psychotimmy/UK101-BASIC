...
250 W=62:D=24
260 REM *** Variables
270 REM Generation number, living cells, randomizer & array
280 Z=0:E=0:R=12
290 DIM G(W,D)
300 REM *** Clear screen and set up scroll area
310 PRINT CHR$(26)
320 GOSUB 5000
...
1050 PRINT CHR$(30):PRINT "Generation";Z
1060 RETURN
2000 REM *** INITIALISE LIFE CELLS
2010 FOR I=1 TO W
2020 FOR J=1 TO D
2030 G(I,J)=32:IF INT(RND(1)*R)=7 THEN G(I,J)=L:E=E+1
2040 NEXT J
2050 NEXT I
2060 RETURN
...
3050 NEXT J
3060 NEXT I
3070 PRINT CHR$(30):PRINT "Generation";Z
3080 PRINT "Living cells";E
3090 RETURN
...
4110 G(I,J)=32:IF((NC=3)OR(NC=2 AND TC=1))THEN G(I,J)=L:E=E+1
4120 NEXT J
4130 NEXT I
4140 RETURN
